const birdsDataEn = [
  [
    ...
    },
    {
      ...
      description:
        'Nightjar is an inconspicuous bird known for its voice. The song of the nightjar sounds like a monotonous trill similar to the rattling of a motorcycle. From dusk to dawn such rattling is heard, its tonality, frequency and volume change. ',
    ...
    },
    {
      ...
      description:
        'The cuckoo was named this way because of the peculiarities of its songs. The voiced “cuckoo” cannot be confused with any other bird. Cuckoos do not build nests, their offspring are raised by other species of birds, to which cuckoos throw their eggs.',
    ...
    },
    {
      ...
      species: 'Parus major',
      description:
        'More than 40 different sound combinations are distinguished in the chirping of tits. They sing almost entire year, fading a little only in winter. Tits are real orderlies of the forest. One pair of tits during the nesting period protects dozens of trees from pests.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'When the jay is worried, the tuft on her head is ruffled. The bird tries to create a frightening sight. Jays are able to imitate the voices of other birds, animals and sounds that humans create. For the winter they make large stocks of acorns and nuts.',
  ...
  [
    {
      ...
      description:
        'In the wild, there are 450 species of finches. In winter, finches lead a flocking lifestyle. Sometimes sparrows can be seen in their families. Finches sing in the spring, with the onset of the mating season. Their singing is gushing multi-minute roulades.',
    ...
    },
    {
      ...
      description:
        'Crossbills are called "Christmas" birds. Under natural conditions, they give birth in winter - in January. These birds insulate their nests with moss and animal hair, so their younglings are not cold. Crossbills can fly up to 3500 km from the nest in search of cones.',
    ...
    },
    {
      ...
      description:
        'Doves live in mixed and broad-leaved forests, as well as in city parks and towns. This birds often choose life places next to humans and easily get used to people. Thanks to the melodic pleasant singing of turtle doves, they are often bred at home.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'The sizes of this birds are different. The smallest of them are up to 25cm long, the largest - up to 1m, with a wingspan of about 2m. There is a belief that the appearance of a shearwater in the air portends a storm, as the very name of the bird indicates.',
    ...
    },
    {
      ...
      description:
        "The male emperor penguin reaches a height of 130cm, its weight can approach 50kg. Of all modern penguins, this species is the largest. The penguin's diet consists of fish, squid and krill. Birds hunt in the ocean in large groups.",
    ...
    },
    {
      ...
      description:
        ' Also known as seagulls this birds inhabit the shores of the seas, lakes, rivers, reservoirs, swamps, often nest on islands. Since the end of the last century, gulls began to appear in large cities, where they nest on the roofs of buildings. All gulls lead a colonial lifestyle.',
